...
\clearpage
      ...
      \item lat1 : double\\
      Atribut lat1 menyimpan informasi \textit{latitude} untuk point1.
      
      \item lon1 : double\\
      Atribut lon1 menyimpan informasi \textit{longitude} untuk point1.
      
      \item lat2 : double\\
      Atribut lat2 menyimpan informasi \textit{latitude} untuk point2.
