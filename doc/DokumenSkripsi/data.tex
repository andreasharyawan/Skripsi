...
Based on testing has been done, the application has succeed to model OSMXML into
the form of graph and search the closest route between the source and destination point 
using Dijkstra algorithm. The application also has succeeded in making graph visualization 
and closest route using Google Maps Javascript
API.}
