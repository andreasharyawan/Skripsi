...
closest route, use map data provided by OpenStreetMap. OpenStreetMap is an
opensource map portal that provides data in the form of a map image and XML
document which is called by OSMXML. The application can be used by the driver to help 
looking for a closest route to the destination more quickly. The Application use data in
OSMXML and dijkstra algorithm to find the closest route. The Application show
